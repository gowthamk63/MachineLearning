...
train_data=pd.read_csv('amazon_baby_train.csv').dropna()
test_data=pd.read_csv('amazon_baby_test.csv').dropna()
...
clf= AdaBoostClassifier(DecisionTreeClassifier(min_samples_split=500),n_estimators=600,learning_rate=1.5,algorithm="SAMME")
